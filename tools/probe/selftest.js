...
//
// feeds synthetic captures that mimic controls we HAVE measured on real hardware
// (see notes/RESEARCH.md) and asserts the probe re-derives the same conclusion.
...
console.log('\nre-deriving known hardware facts (notes/RESEARCH.md):');
