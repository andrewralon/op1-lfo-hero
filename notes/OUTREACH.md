...
> fx, tape transport, clock sync. it currently supports the **op-1 field**, **tx-6** and **tp-7**.
>
...
> anyone here have an **op-1 (original)**? i make a free midi lfo app for te gear (op-1 field, tx-6,
> tp-7) and i'd love to add the og, but i don't own one and can't test against it.
>
